...
import io.github.kennethchoinfosec.haven.services.KillerService;
...
public class MainActivity extends AppCompatActivity {
    public static final String BROADCAST_CONTEXT_MENU_CLOSED = "io.github.kennethchoinfosec.haven.broadcast.CONTEXT_MENU_CLOSED";
    public static final String BROADCAST_SEARCH_FILTER_CHANGED = "io.github.kennethchoinfosec.haven.broadcast.SEARCH_FILTER_CHANGED";
    ...
    private void bindServices() {
        ...
        ((HavenApplication) getApplication()).bindHavenService(new ServiceConnection() {
            ...
            public void onServiceConnected(ComponentName name, IBinder service) {
                mServiceMain = IHavenService.Stub.asInterface(service);
                tryStartWorkService();
            }
    ...
    private void bindWorkService() {
        // Bind to the HavenService in work profile
    ...
    private void bindWorkServiceCb(ActivityResult result) {
        if (result.getResultCode() == RESULT_OK && result.getData() != null) {
            ...
            mServiceWork = IHavenService.Stub.asInterface(binder);
    ...
    private void startKiller() {
        // Start the sticky KillerService to kill the HavenService
    ...
    // remote (work) -> main
    // main -> remote (work)
    IHavenService getOtherService(boolean isRemote) {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (itemId == R.id.main_menu_freeze_all) {
            ...
            Utility.createLauncherShortcut(this, launchIntent,
                    ...
                    "Haven-freeze-all", getString(R.string.freeze_all_shortcut));
            return true;
