...
import io.github.kennethchoinfosec.haven.services.FreezeService;
...
import io.github.kennethchoinfosec.haven.services.IFileShuttleServiceCallback;
...
import io.github.kennethchoinfosec.haven.util.InstallationProgressListener;
...
public class DummyActivity extends Activity {
    public static final String FINALIZE_PROVISION = "io.github.kennethchoinfosec.haven.action.FINALIZE_PROVISION";
    public static final String START_SERVICE = "io.github.kennethchoinfosec.haven.action.START_SERVICE";
    public static final String TRY_START_SERVICE = "io.github.kennethchoinfosec.haven.action.TRY_START_SERVICE";
    public static final String INSTALL_PACKAGE = "io.github.kennethchoinfosec.haven.action.INSTALL_PACKAGE";
    public static final String UNINSTALL_PACKAGE = "io.github.kennethchoinfosec.haven.action.UNINSTALL_PACKAGE";
    public static final String UNFREEZE_AND_LAUNCH = "io.github.kennethchoinfosec.haven.action.UNFREEZE_AND_LAUNCH";
    public static final String PUBLIC_UNFREEZE_AND_LAUNCH = "io.github.kennethchoinfosec.haven.action.PUBLIC_UNFREEZE_AND_LAUNCH";
    public static final String PUBLIC_FREEZE_ALL = "io.github.kennethchoinfosec.haven.action.PUBLIC_FREEZE_ALL";
    public static final String FREEZE_ALL_IN_LIST = "io.github.kennethchoinfosec.haven.action.FREEZE_ALL_IN_LIST";
    ...
    public static final String START_FILE_SHUTTLE = "io.github.kennethchoinfosec.haven.action.START_FILE_SHUTTLE";
    public static final String START_FILE_SHUTTLE_2 = "io.github.kennethchoinfosec.haven.action.START_FILE_SHUTTLE_2";
    public static final String SYNCHRONIZE_PREFERENCE = "io.github.kennethchoinfosec.haven.action.SYNCHRONIZE_PREFERENCE";
    public static final String PACKAGEINSTALLER_CALLBACK = "io.github.kennethchoinfosec.haven.action.PACKAGEINSTALLER_CALLBACK";
    ...
    private void actionStartService() {
        ...
        ((HavenApplication) getApplication()).bindHavenService(new ServiceConnection() {
            @Override
    ...
    private void doStartFileShuttle() {
        ((HavenApplication) getApplication()).bindFileShuttleService(new ServiceConnection() {
            @Override
            public void onServiceConnected(ComponentName name, IBinder service) {
